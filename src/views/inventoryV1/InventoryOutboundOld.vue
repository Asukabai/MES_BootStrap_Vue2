  ...
  <div class="inventory-outbound-mobile">
      ...
      <div class="card item-card">
        ...
        <div class="card-body">
          ...
          <div class="info-list">
            ...
            <div class="info-item">
              <span class="info-label">最大可领</span>
              <span class="info-value">{{ itemData.Current_Stock }}</span>
            </div>
          </div>
          <!-- 出库数量 -->
          <div class="form-group">
            ...
            <div class="input-hint">
              出库后库存: <span class="highlight">{{ itemData.Current_Stock - outboundQuantity }}</span>
            </div>
          </div>
          <!-- 出库类型 -->
          <div class="form-group">
          ...
          <!-- 关联项目 -->
          <div class="form-group" v-show="outboundType === 4">
    ...
    <div v-if="showSuccess" class="success-overlay">
      <div class="success-content">
        ...
        <h3 class="success-title">出库成功</h3>
        <p class="success-message">物品已成功出库</p>
    ...
    async onConfirm() {
      ...
      try {
        ...
        const requestData = {
          ...
          Current_Stock: this.itemData.Current_Stock - this.outboundQuantity, // 出库后的库存量
