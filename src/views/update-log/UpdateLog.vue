...
export default {
  ...
  data() {
    return {
      updateLogs: {
        '1.1.56': 'MES系统更新V1.1.56_会议管理（在线批注功能集成到稳定版）and任务管理and项目管理（新增模糊条件搜索）；',
        '1.1.55': 'MES系统更新V1.1.55_会议管理（新增共享屏幕下的在线批注功能）；',
        '1.1.54': 'MES系统更新V1.1.54_任务日报（任务日报-2，修改测试Bug）（共享文件支持模糊搜索功能）；',
        '1.1.53': 'MES系统更新V1.1.53_任务日报（任务日报-1，新增移动端新增，查看，编辑日报功能；',
        '1.1.52': 'MES系统更新V1.1.52_会议管理（会议管理2 ，修复视频会议移动端链接丢失问题-3；',
        '1.1.51': 'MES系统更新V1.1.51_会议管理（会议管理2 ，修复视频会议移动端链接丢失问题-2；',
        '1.1.50': 'MES系统更新V1.1.50_会议管理（修改视频会议样式-适配移动端布局-5；新增会议管理2 ，新增音频检测功能，修复视频会议移动端链接丢失问题-1；',
        '1.1.49': 'MES系统更新V1.1.49_会议管理（修改视频会议样式-适配移动端布局-4；修复视频会议移动端共享屏幕黑屏显示问题；',
        '1.1.48': 'MES系统更新V1.1.48_会议管理（修改视频会议样式-适配移动端布局-3；修复视频会议人数不一致的问题修，悬浮弹窗显示问题；',
        '1.1.47': 'MES系统更新V1.1.47_会议管理（修改视频会议样式-适配移动端布局-2；1、修复移动端共享屏幕比例问题，支持参会者全屏观看视频会议（开启屏幕旋转）\n' +
          '2、支持参会者进入会议时，默认关闭摄像头和麦克风 3、修改移动端进入会议时，当会议名称过长时，挤压其他组件导致的页面变形情况）；',
        '1.1.46': 'MES系统更新V1.1.46_会议管理（修改视频会议样式-适配移动端布局-1；新增库存管理操作记录报表导出功能）；',
        '1.1.45': 'MES系统更新V1.1.45_会议管理（新增主持人功能）；',
        '1.1.44': 'MES系统更新V1.1.44_会议管理（修改视频会议中页面跳转链接-确保会议链接安全性）；',
        '1.1.43': 'MES系统更新V1.1.43_库存管理（新增出库or入库情况下关联项目和使用用户功能）；',
        '1.1.42': 'MES系统更新V1.1.42_会议管理（基础功能-8（修复视频会议共享屏幕的显示清晰度问题）；',
        '1.1.41': 'MES系统更新V1.1.41_会议管理（基础功能-7（修复视频会议共享屏幕的显示问题（清晰度待解决））；',
        '1.1.40': 'MES系统更新V1.1.40_会议管理（基础功能-6（修复视频会议参与者名称显示问题-1）；',
        '1.1.39': 'MES系统更新V1.1.39_会议管理（基础功能-5（修复视频会议卡顿问题-1）；',
        '1.1.38': 'MES系统更新V1.1.38_会议管理（基础功能-4（增加视频会议屏幕共享功能-修复Bug和样式问题））；',
        '1.1.37': 'MES系统更新V1.1.37_会议管理（基础功能-3（增加视频会议屏幕共享功能））；',
        '1.1.36': 'MES系统更新V1.1.36_会议管理（基础功能-2（增加视频会议基础功能））；',
        '1.1.35': 'MES系统更新V1.1.35_会议管理（基础功能-1）；',
        '1.1.34': 'MES系统更新V1.1.34_库存管理（增加库存信息查询导出功能-2(修复已知Bug，支持自动提示查询结果)）；',
        '1.1.33': 'MES系统更新V1.1.33_库存管理（增加库存信息查询导出功能-1）；',
        '1.1.32': 'MES系统更新V1.1.32_库存管理（（1）管理页面支持联合搜索（2）新增和修改物品信息时，关联项目带项目编码，且能按项目编码搜索）；',
        '1.1.31': 'MES系统更新V1.1.31_库存管理（修复嘉立创物品快速录入-第三版使用Bugs-2）；',
        '1.1.30': 'MES系统更新V1.1.30_库存管理（修复嘉立创物品快速录入-第三版使用Bugs-1）；',
